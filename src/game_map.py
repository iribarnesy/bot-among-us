...
class SkeldMap():
    def __init__(self, map_image_path):
        ...
        self.taskManager.tasks = [
            Task(0, "Align Engine (Upper Engine)", (273, 355), indicator_location=(273, 355), solve_function=self.taskManager.align_engine_output, task_type=TaskType.Align_Engine_Output),
            Task(1, "Align Engine (Lower Engine)", (275, 854), indicator_location=(275, 854), solve_function=self.taskManager.align_engine_output, task_type=TaskType.Align_Engine_Output),
            Task(2, "Calibrate Distributor", (817, 643), indicator_location=(817, 643), solve_function=self.taskManager.calibrate_distributor, task_type=TaskType.Calibrate_Distributor),
            Task(3, "Chart Course", (1796, 432), indicator_location=(1796, 432), solve_function=self.taskManager.chart_course, task_type=TaskType.Chart_Course),
            ...
            Task(5, "Clear Asteroids", (1430, 262), indicator_location=(1430, 262), solve_function=self.taskManager.clear_asteroids, task_type=TaskType.Clear_Asteroids),
            Task(6, "Divert Power", (690, 635), indicator_location=(691, 613), solve_function=self.taskManager.divert_power, task_type=TaskType.Divert_Power),
            ...
            Task(11, "Accept Power (O2)", (1400, 441), indicator_location=(1400, 441), solve_function=self.taskManager.accept_power, task_type=TaskType.Accept_Power),
            Task(12, "Accept Power (Security)", (562, 462), indicator_location=(564, 442), solve_function=self.taskManager.accept_power, task_type=TaskType.Accept_Power),
            Task(13, "Accept Power (Shields)", (1496, 763), indicator_location=(1498, 732), solve_function=self.taskManager.accept_power, task_type=TaskType.Accept_Power),
            Task(14, "Accept Power (Weapons)", (1525, 252), indicator_location=(1525, 252), solve_function=self.taskManager.accept_power, task_type=TaskType.Accept_Power),
            Task(15, "Empty Garbage/Chute (Cafeteria)", (1241, 176), indicator_location=(1241, 176), solve_function=self.taskManager.empty_chute, task_type=TaskType.Empty_Chute),
            ...
            Task(27, "Inspect Sample", (808, 513), indicator_location=(808, 513), solve_function=self.taskManager.inspect_sample, task_type=TaskType.Inspect_Sample),
            ...
            Task(29, "Stabilize Steering", (1824, 532), indicator_location=(1824, 532), solve_function=self.taskManager.stabilize_steering, task_type=TaskType.Stabilize_Steering),
            ...
            Task(31, "Submit Scan", (757, 552), indicator_location=(757, 552), solve_function=self.taskManager.submit_scan, task_type=TaskType.Submit_Scan),
            ...
            Task(34, "Download/Upload (Cafeteria)", (1200, 137), indicator_location=(1200, 137), solve_function=self.taskManager.download_upload, task_type=TaskType.Download_Upload),
            Task(35, "Download/Upload (Admin)", (1160, 593), indicator_location=(1160, 593), solve_function=self.taskManager.download_upload, task_type=TaskType.Download_Upload),
            Task(36, "Download/Upload (Communications)", (1215, 908), indicator_location=(1215, 906), solve_function=self.taskManager.download_upload, task_type=TaskType.Download_Upload),
            Task(37, "Download/Upload (Electrical)", (655, 585), indicator_location=(655, 585), solve_function=self.taskManager.download_upload, task_type=TaskType.Download_Upload),
